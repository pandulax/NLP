...
def fextract(index, string_index = {}):
    ...
    v10 = proper_noun(string_index[index])
    
    v11 = ngram_count(string_index[index], closure_list)
    
    v12 = ngram_count(string_index[index], disclaimer_list)
    
    
    dataset_arr_list = [v1] + [v2] + [v3] + [v4] + [v5] + [v6] + [v7] + [v8] + [v9] + [v10] + v11 + v12
