...
closure_list = ['all best', 'all the best', 'b Regards', 'best', 'bests', 'best regards', 'best wishes', 'ciao', 'cheers', 'cordially', 'cordially yours', 'faithfully', 'fond regards', 'kind regards', 'many thanks', 'my best to you', 'rgds', 'regards', 'respectfully', 'respectfully yours', 'sincerely', 'sincerely yours', 'see you around', 'take care', 'thank you', 'thank you best regards', 'thank you and best regards', 'thank you b regards', 'thank you and b regards', 'thanks again', 'thanks regards', 'thanks and regards', 'thanks b regards', 'thanks and b regards', 'thanks so much', 'warmly', 'warmest', 'warm gratitude', 'warm regards', 'warmest regards', 'with appreciation', 'with gratitude', 'with sincere appreciation', 'with sincere thanks', 'yours truly', 'yours sincerely', 'yours faithfully']

disclaimer_list = ['disseminate', 'contain', 'disclose', 'virus', 'liable', 'liability', 'confidential', 'privileged', 'mail', 'warning', 'content', 'message', 'notice', 'transmit', 'individual', 'entity', 'immediate', 'distribute', 'prohibit', 'damage', 'authori', 'conclude', 'organization', 'attorney', 'protect']
...
def ngramcount(self, string_line ='', nglist = []):
    temp_str = string_line.lower()
    string_line = ' '.join(temp_str.split())
...
directory = 'label_Chathurika'
#directory = 'EmailTagging'
